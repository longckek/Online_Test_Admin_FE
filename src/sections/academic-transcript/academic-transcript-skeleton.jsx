...
export function AcademicTranscriptItemSkeleton({ sx, ...other }) {
  return (
    <Paper
      variant="outlined"
      sx={{
...
AcademicTranscriptItemSkeleton.propTypes = {
  sx: PropTypes.object,
};

// ----------------------------------------------------------------------

export function AcademicTranscriptDetailsSkeleton({ ...other }) {
  return (
